...
def colormap_to_matrice(Colormap_Path, Dico):
    ...
    np.savetxt("./data/Matrice.csv", Mat, delimiter=";", fmt='%i')

Dico = {(255, 0, 0, 255):0, (255, 255, 255, 255):1, (0, 255, 164, 255):2, (0, 82, 0, 255):3, (0, 255, 0, 255): 4, (0, 0, 0, 255): 6, 
        (255, 135, 0, 255):7, (255, 0, 249, 255):8, (0, 63, 255, 255):52, (0, 255, 255, 255):51, (254, 255, 0, 255):100  }
colormap_to_matrice("./carte2_collision_compresse.png", Dico)